        ...
        <div class="card-body">
            <div class="">
                <div class="row">
                    ...
                    <div class="col-sm-4">
                        <form action="/backend/report" method="post">
        ...
        <div class="table-responsive cart_info">
            <table class="table table-condensed">
                ...
                <tr class="cart_menu">
                    ...
                    <td class="col-sm-2">Số lượng nhập</td>
                    <td class="col-sm-2">Số lượng tồn kho</td>
                ...
                <c:forEach items="${listInventory}" var="a">
                    <tr>
                        ...
                        <td>
                            <h5 class="btn btn-success">${a[2]}</h5>
                        </td>
                        <td>
                            <h5 class="btn btn-primary">${a[3]}</h5>
                        </td>
                        <td>
                            <h5 class="btn btn-primary">${a[4]}</h5>
                        </td>
<%--                        <td>--%>
